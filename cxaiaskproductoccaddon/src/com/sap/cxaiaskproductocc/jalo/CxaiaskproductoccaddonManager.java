 ...
 */
package com.sap.cxaiaskproductocc.jalo;
...
import com.sap.cxaiaskproductocc.constants.CxaiaskproductoccaddonConstants;



/**
 * This is the extension manager of the cxaiaskproductoccaddon extension.
 */
public class CxaiaskproductoccaddonManager extends GeneratedCxaiaskproductoccaddonManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(CxaiaskproductoccaddonManager.class.getName());
	 ...
	 */
	public CxaiaskproductoccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CxaiaskproductoccaddonManager called.");
		}
	}
	 ...
	 */
	public static CxaiaskproductoccaddonManager getInstance()
	{
		return (CxaiaskproductoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CxaiaskproductoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CxaiaskproductoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CxaiaskproductoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}

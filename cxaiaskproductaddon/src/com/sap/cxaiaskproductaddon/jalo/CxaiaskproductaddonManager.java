 ...
 */
package com.sap.cxaiaskproductaddon.jalo;
...
/**
 * This is the extension manager of the Cxaiaskproductaddon extension.
 */
public class CxaiaskproductaddonManager extends GeneratedCxaiaskproductaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CxaiaskproductaddonManager.class.getName());
	 ...
	 */
	public static CxaiaskproductaddonManager getInstance()
	{
		return (CxaiaskproductaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CxaiaskproductaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CxaiaskproductaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CxaiaskproductaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CxaiaskproductaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CxaiaskproductaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
